  ...
  return (
    <div className="p-4 mt-24">
      ...
      {notifications.length === 0 ? (
        ...
        <>
         <button className="bg-purple-500 text-white w-1/3 mx-auto px-4 py-2 rounded mb-4 flex justify-center" onClick={()=>{MarkAllRead()}}>
            Mark all as read
        </button>
              ...
              {notifications.map((notification) => (
                <tr key={notification.id}>
                  ...
                  <td className="border border-gray-200 px-4 py-2">
                    <button className="bg-violet-500 text-white px-2 py-1 rounded" onClick={()=>{MarkRead(notification)}}>
                      Mark as read
                    </button>
                  </td>
                </tr>
